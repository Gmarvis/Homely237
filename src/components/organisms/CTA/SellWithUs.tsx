      ...
      <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
        <div className="max-w-xl space-y-3 md:mx-auto">
          ...
          <p className="text-gray-600">
            Share your expertise by becomming a Homygig service provider now. on our platform, you
            are not confined to a fixed location for work. your job is to list you services ours is
            to source and provide clients for you.
          </p>
        </div>
        <div className="mt-4">
