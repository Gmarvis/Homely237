const Testimonils = () => {
    const testimonials = [
        {
            avatar: 'https://i.pinimg.com/236x/54/15/2d/54152d5a198768bae10db95d59887008.jpg',
            name: 'Sarah K',
            title: 'high school teacher',
            quote: 'I used to spend hours calling around and comparing prices for simple things like appliance repair.With Homygig, I can find qualified professionals in minutes and book appointments easily'
        },
        {
            avatar: 'https://i.pinimg.com/236x/ff/4e/63/ff4e634f1fc5dfe0c573fc6e131957d3.jpg',
            name: 'David',
            title: 'Software engineer',
            quote: "The technicians I've booked have all been professional, reliable, and trustworthy.  They fixed my plumbing issue quickly and efficiently, and the pricing was fair.  I highly recommend Homygig!"
        },
        {
            avatar: 'https://i.pinimg.com/236x/c1/59/f4/c159f47aea63fd7f76436684fd9c62d8.jpg',
            name: 'Jean Perez N',
            title: 'Banker',
            quote: 'whatever service i need, I can find them all on Homygig.  The variety of services offered is fantastic, and it saves me the trouble of searching for different companies for each job'
        }
    ];

    return (
        <section className="relative bg-slate-100 py-14">
            <div className="relative  z-10 max-w-screen-xl mobile:max-sm:px-5 mx-auto px-24 md:px-16">
                <div className="max-w-xl sm:text-center  md:mx-auto mobile:max-sm:text-center">
                    <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                        Hear from our customers
                    </h3>
                    <p className="mt-3 text-gray-600">
                        Ready to experience the homygig difference for yourself? Join the many
                        satisfied customers who have enjoyed a seamless experience!
                    </p>
                </div>
                <div className="mt-12 ">
                    <ul className="grid items-center gap-10  sm:grid-cols-2 lg:grid-cols-3">
                        {testimonials.map((item, idx) => (
                            <li key={idx} className="bg-white rounded-xl border shadow-md">
                                ...
                                <figure>
                                    <blockquote>
                                        <p className="text-gray-800 text-sm  px-4 py-1">
                                            {item.quote}
                                        </p>
                                    </blockquote>
                                    <div className="flex items-center gap-x-4 p-4 mt-6 ">
                                        ...
                                        <div>
                                            ...
                                            <span className="block text-primarytheme text-sm mt-0.5">
                                                {item.title}
                                            </span>
                                        </div>
                                    </div>
