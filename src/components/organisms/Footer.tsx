...
const Footer = () => {
  ...
  return (
    <footer className="text-gray-500  px-24 py-5 mobile:max-sm:px-5 bg-primarytheme">
      <div className="grid grid-cols-5 sm:max-md:grid-cols-2 mobile:max-sm:grid-cols-1 mobile:max-sm:gap-3">
        <div className="logo-footer-section flex flex-col gap-2">
          ...
          <p className="text-[12px] text-gray-700">
            It has never been more easy to find home service providers in
            cameroon than now, thanks to homygig, customers are happy and
            service providers are exited, we are proud for making life better in
            Cameroon.
          </p>
          <SocialLinks />
        </div>
        ...
        <div className="subscribe flex flex-col w-full gap-4 px-2">
          ...
          <p className="text-[12px] text-gray-700">
            Stay up-to-date with our latest trends and news by subscribing to
            our newsletters
          </p>
