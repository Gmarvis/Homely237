  ...
  return (
    <>
      <div className="min-h-screen">
        ...
        <div className=" h-[80vh] pt-16 flex px-24 items-center justify-between bg-gradient-to-r  bg-primarytheme">
          ...
          <div className="shapes grid grid-cols-2 gap-4">
            {gridImages.map((image, i) => (
              <div
                ...
                className={`bg-white shadow-sm w-64  bg-center bg-cover h-48 transition-all duration-300 ${
                  i === 0 ? "rounded-tl-full" : ""
                } ${i === 3 ? "rounded-br-full" : ""} `}
              ></div>
            ))}

            {/* <div className="bg-white shadow-sm w-64 bg-[url('https://i.pinimg.com/736x/5c/6a/b6/5c6ab6f93e9d5c83a773698c8ddf25ff.jpg')] bg-center bg-cover h-48 rounded-tl-full"></div>
            <div className="bg-white shadow-sm w-64 bg-[url('https://i.pinimg.com/564x/26/fe/04/26fe04dfda1ff7a980a6e8d69fb43151.jpg')] bg-center bg-cover h-48"></div>
            <div className="bg-white shadow-sm w-64 bg-[url('https://i.pinimg.com/564x/84/17/79/841779ded57a77c275909fe55bb70605.jpg')] bg-center bg-cover h-48"></div>
            <div className="bg-white shadow-sm w-64 bg-[url('https://i.pinimg.com/564x/8d/9a/c0/8d9ac086df0763977f05aca1b7a79408.jpg')] bg-center bg-cover h-48 rounded-br-full"></div> */}
          </div>
        </div>
        <div></div>
      </div>
