...
const Table = () => {
  ...
  useEffect(() => {
    QUERIES.getProvidersAnointments(user.id).then((res) => setApointments(res));
  }, []);
    ...
    <div className="max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="items-start justify-between md:flex">
        <div className="max-w-lg">
          ...
          <p className="text-gray-600 mt-2">Approve, decline and reschedule appointments here!</p>
        </div>
      </div>
              ...
              >
                <td className="flex items-center gap-x-3 py-3 px-6 whitespace-nowrap ">
                  ...
                  <div>
                    ...
                    <span className="block text-gray-700 text-xs">{appointment.user.email}</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">{appointment.phone_number}</td>
