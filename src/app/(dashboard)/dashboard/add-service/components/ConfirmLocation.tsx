...
const ConfirmLocation = ({ onNextClick, onClickBack }: PropType) => {
  ...
  return (
    <div className="w-full max-w-lg space-y-2">
      ...
      <p>
        Your current loation is gotten based on you network, if this is invalid, please consider
        checking your network or swithcing off VPN then restart this page{' '}
      </p>
