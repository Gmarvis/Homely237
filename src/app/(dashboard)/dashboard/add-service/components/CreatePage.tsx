...
import { createService } from '@/core/utils/queries';
...
const CreatePage = ({ ...props }: PropType) => {
  ...
  return (
    <div className="h-full w-full flex justify-center items-center">
      {data && (
        <div className="div text-center shadow-md w-full max-w-xl py-4 mt-10 flex flex-col gap-2 p-2">
          ...
          <Button
            disabled={loading}
            className="bg-primarytheme disabled:bg-gray-800 py-10 text-2xl"
          ...
          <span
            ...
            className="bg-primarytheme hover:bg-secondrytheme py-5 text-sm"
          >
            take another look
          </span>
        </div>
